...
public class RegistroLogic {
    ...
    public RegistroEntity updateRegistro(Long productosId, RegistroEntity registroEntity) throws BusinessLogicException {
         LOGGER.log(Level.INFO, "Inicia proceso de actualizar el registro con id = {0} del producto con id = {1}" , new Object[] {registroEntity.getId(), productosId});
        if (!validateRegistro(registroEntity.getTipoRegistro())) {
           throw new BusinessLogicException("El TipoRegistro es inválido");
        }
        ProductoEntity productoEntity = productoPersistence.find(productosId);
        ...
        LOGGER.log(Level.INFO, "Termina proceso de actualizar el registro con id = {0} del producto con id = {1}", new Object[] {registroEntity.getId(), productosId});
    ...
    public void deleteRegistro(Long productosId, Long registrosId)throws BusinessLogicException {
        LOGGER.log(Level.INFO, "Inicia proceso de borrar el registro con id = {0} del producto con id = {1}" , new Object[] {registrosId, productosId});
        ...
        LOGGER.log(Level.INFO, "Termina proceso de borrar el registro con id = {0} del producto con id = {1}" , new Object[] {registrosId, productosId});
    }
