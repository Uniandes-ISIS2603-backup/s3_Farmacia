...
public class ClientePersistence {
    ...
    /**
     * Busca un cliente entre todos los clientes que esten en la base de datos
     *
     * @param clienteId
     * @return
     */
    ...
    /**
     * Elimina a un determiando cliente con un determiando id
     *
     * @param clienteId
     */
    ...
    public void delete2(Long clienteId) {
        ...
        if (cli.getTransaccionesCliente() != null) {
            for (int i = 0; i < cli.getTransaccionesCliente().size(); i++) {
                tcp.delete(cli.getTransaccionesCliente().get(i).getId());
            }
        }
    ...
    /**
     * Encuentra un cliente por medio de la cedula, esta numero de cedula es
     * unico
     *
