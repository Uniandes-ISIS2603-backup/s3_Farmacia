...
public class TransaccionProveedorPersistence {
    ...
    public TransaccionProveedorEntity find(Long proveedorId, Long transaccionProveedorId) {
        LOGGER.log(Level.INFO, "Consultando la transaccionProveedor con id = {0} del proveedor con id = {1}", new Object[]{transaccionProveedorId,proveedorId});
        ...
        TransaccionProveedorEntity transaccionProveedor;
        if (results == null) {
